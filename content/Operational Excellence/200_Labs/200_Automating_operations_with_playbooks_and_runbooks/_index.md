...
* It does not allow your operational practice to scale well with growing demand of your business. 
...
* An [AWS account](https://portal.aws.amazon.com/gp/aws/developer/registration/index.html) that you are able to use for testing. The account should not be used for production purposesor.  
* An [IAM user](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users.html) in your AWS account with full access to [CloudFormation](https://aws.amazon.com/cloudformation/), [Amazon EC2](https://aws.amazon.com/ec2/), [Amazon Virtual Private Cloud (VPC)](https://aws.amazon.com/vpc/), [AWS Identity and Access Management (IAM)](https://aws.amazon.com/iam/).  
